...
/**
 * Created by yanfa6 on 2017/7/31.
 */
...
public class LoveLayout extends RelativeLayout{
    ...
    private void initView() {
        firstDrawable=getResources().getDrawable(R.drawable.xin1);
        mDrawablesList.add(firstDrawable);
        secondDrawable=getResources().getDrawable(R.drawable.xin2);
        mDrawablesList.add(secondDrawable);
        threeDrawable=getResources().getDrawable(R.drawable.xin3);
